...
public class Utilidades {
    ...
    static{
        albList.add(new Album(1,"Oktubre","Patricio Rey y sus Redonditos de Ricota",1986,"Oktubre es el segundo álbum de estudio del grupo de rock argentino Patricio Rey y sus Redonditos de Ricota. Fue editado en octubre de 1986. Grabado a mediados de 1986.", com.example.gramola.R.drawable.images));
    ...
    public static void delAlbum(Album album) {
        for (int i = 0; i < albList.size(); i++) {
            if (albList.get(i).getIdAlb() == album.getIdAlb()) {
                albList.remove(i);
                break;
            }
        }
